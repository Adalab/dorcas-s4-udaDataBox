...
function getIndicator(token, currentPeriod) {
    ...
    return new Promise(function (resolve, reject) {
        request.get(reports.url, { headers: reports.headers }).then(function (res) {
            return resolve(res);
        }).catch(function (e) {
...
export function getActive(token, portfolioId, data) {
    ...
    return new Promise(function (resolve, reject) {
        request.post(reports.url, data, { headers: reports.headers }).then(function (res) {
            resolve(res);
        }).catch(function (e) {
            resolve(e.response);
        });
...
export function getPeriod(token) {
    ...
    return new Promise(function (resolve, reject) {
        request.get(reports.url, { headers: reports.headers }).then(function (resp) {
            console.log(resp);
            getIndicator(token, resp.data.period.code).then(function (res) {
                return resolve(res.data[resp.data.period.code]);
            });
        }).catch(function (e) {
            //resolve(e.response.data.error)
            resolve(e.response);
